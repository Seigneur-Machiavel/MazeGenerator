const { METADATA_DISTANCE, METADATA_PATH, METADATA_MAX_DISTANCE, METADATA_MASKED, METADATA_CURRENT_CELL, METADATA_UNPROCESSED_CELL,
...
function buildSquareGrid(config) {
    "use strict";
...
function buildTriangularGrid(config) {
    "use strict";
    const {drawingSurface: defaultDrawingSurface} = config,
        grid = buildBaseGrid(config),
...
function buildHexagonalGrid(config) {
    "use strict";
    const {drawingSurface: defaultDrawingSurface} = config,
        grid = buildBaseGrid(config);
...
function buildCircularGrid(config) {
    "use strict";
