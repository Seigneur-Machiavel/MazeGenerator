const {buildSquareGrid, buildTriangularGrid, buildHexagonalGrid, buildCircularGrid} = require('./maze.js');
const {drawingSurfaces} = require('./drawingSurfaces.js');
const {buildRandom} = require('./random.js');
